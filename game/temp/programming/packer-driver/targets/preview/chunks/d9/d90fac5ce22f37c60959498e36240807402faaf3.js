System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "@socket.io/component-emitter", "engine.io-parser", "__unresolved_4"], function (_export, _context) {
  "use strict";

  var DEFAULT_TRANSPORTS, installTimerFunctions, byteLength, decode, parse, Emitter, protocol, createCookieJar, defaultBinaryType, nextTick, SocketWithoutUpgrade, SocketWithUpgrade, Socket, withEventListeners, OFFLINE_EVENT_LISTENERS;

  _export({
    SocketWithoutUpgrade: void 0,
    SocketWithUpgrade: void 0,
    Socket: void 0
  });

  return {
    setters: [function (_unresolved_) {
      DEFAULT_TRANSPORTS = _unresolved_.transports;
    }, function (_unresolved_2) {
      installTimerFunctions = _unresolved_2.installTimerFunctions;
      byteLength = _unresolved_2.byteLength;
    }, function (_unresolved_3) {
      decode = _unresolved_3.decode;
    }, function (_unresolved_4) {
      parse = _unresolved_4.parse;
    }, function (_socketIoComponentEmitter) {
      Emitter = _socketIoComponentEmitter.Emitter;
    }, function (_engineIoParser) {
      protocol = _engineIoParser.protocol;
    }, function (_unresolved_5) {
      createCookieJar = _unresolved_5.createCookieJar;
      defaultBinaryType = _unresolved_5.defaultBinaryType;
      nextTick = _unresolved_5.nextTick;
    }],
    execute: function () {
      ...
      _export("SocketWithoutUpgrade", SocketWithoutUpgrade = class SocketWithoutUpgrade extends Emitter {
        /**
         * Socket constructor.
         *
      ...
      _export("SocketWithUpgrade", SocketWithUpgrade = class SocketWithUpgrade extends SocketWithoutUpgrade {
        constructor() {
          super(...arguments);
          this._upgrades = [];
        }
      ...
      _export("Socket", Socket = class Socket extends SocketWithUpgrade {
        constructor(uri, opts) {
          if (opts === void 0) {
            opts = {};
          }
...
//# sourceMappingURL=d90fac5ce22f37c60959498e36240807402faaf3.js.map